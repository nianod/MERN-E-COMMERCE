    ...
    <div className="inset-0 fixed flex items-center justify-center -z-50">
      <div className="bg-blue-900 p-6 rounded-lg">
        ...
        <div className="flex justify-between">
          ...
          <button className={`bg-red-500 p-2 text-white font-semibold rounded-lg px-3 hover:bg-red-700 ${loading ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`}>Confirm</button>
        </div>
      </div>
    </div>
  )
