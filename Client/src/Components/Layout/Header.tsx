...
import { FaSearch, FaUser, FaUserCircle, FaCartPlus, FaBars, FaTimes } from "react-icons/fa"
  ...
  return (
    <>
      <div className="flex items-center justify-between top-0 fixed w-full bg-[#382d33] px-4 sm:px-6 py-3 shadow-md z-50">
        ...
        <div className={`
          fixed top-0 left-0 h-full w-64 bg-[#382d33] transform transition-transform duration-300 z-50 md:hidden
